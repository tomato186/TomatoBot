...
let cont = interaction.options&& interaction.options.getUser('owner') && interaction.options.getUser('owner').id || interaction.mentions.users && interaction.mentions.users.first() && interaction.mentions.users.first().id 
console.log(cont)
